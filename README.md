...
Los archivos originales de grafos se llaman "insurance_*ssnn*_grafos_*interaccion*.csv" y están en la carpeta correspondiente a la red social. El archivo final se llama insurance_grafos.csv
